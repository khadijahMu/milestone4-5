      ...
      <div className="homepage-desktop-layout">
          ...
          <div className="hero-section">
            <div className="body">
              ...
              <h4>Discover Uniquely Crafted Bouquets and Gifts for Any <br />
    ...
    <img src={card5} alt="Freshners" className="card-img" />
      ...
      <div className="desktop-divider"></div>
        ...
        <div className="contact-us">
          <img src={rightColum} alt="Contact column" className="colum" />
        </div>
      ...
      <div className="our-service">
        <div className="service-left">
          <h1>Our Service</h1>
          <img src={service} alt="Our service" className="ourService" />
        </div>
        ...
        <div className="sub">
          ...
          <img src={imgBtn} alt="Subscribe button" className="btn2" />
        </div>
      </div>
